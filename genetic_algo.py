"""
    Данный код решает задачу о восьми небьющих друг друга ферзях
    при помощи генетического алгоритма — честно позаимствовал
    псевдокод из интернета; поэтому комментариев не дам :-(
"""
